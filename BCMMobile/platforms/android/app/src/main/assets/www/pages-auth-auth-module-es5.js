...
var AuthPage = /** @class */ (function () {
    function AuthPage(crudService, authService, router, toastController, alertController) {
    ...
    AuthPage.prototype.handleLastNameValue = function (event) {
        this.authData.lastName = event.target.value;
    };
    AuthPage.prototype.handleLoginValue = function (event) {
        this.authData.login = event.target.value;
    };
    AuthPage.prototype.handlePasswordValue = function (event) {
    ...
    AuthPage.prototype.registration = function () {
        ...
        this.crudService.post('profile', this.getParams())
            ...
            var err = 'Такой логин уже существует';
    ...
    AuthPage.prototype.login = function () {
        ...
        this.crudService.post('profile/token', this.getParams())
            ...
            _this.authService.setUserData(data.profileDto);
    ...
    AuthPage.prototype.presentToast = function (error) {
    ...
    AuthPage.prototype.getParams = function () {
        return {
    ...
    AuthPage.prototype.presentAlert = function (error) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
