...
var routes = [
    ...
    {
        path: 'auth',
        loadChildren: function () { return __webpack_require__.e(/*! import() | pages-auth-auth-module */ "pages-auth-auth-module").then(__webpack_require__.bind(null, /*! ./pages/auth/auth.module */ "./src/app/pages/auth/auth.module.ts")).then(function (m) { return m.AuthPageModule; }); }
    }
];
...
/* harmony import */ var _shared_services_localStorage_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./shared/services/localStorage.service */ "./src/app/shared/services/localStorage.service.ts");
...
/* harmony import */ var _shared_services_crud_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./shared/services/crud.service */ "./src/app/shared/services/crud.service.ts");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _ionic_native_camera_preview_ngx__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @ionic-native/camera-preview/ngx */ "./node_modules/@ionic-native/camera-preview/ngx/index.js");
...
/* harmony import */ var _ionic_native_qr_scanner_ngx__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @ionic-native/qr-scanner/ngx */ "./node_modules/@ionic-native/qr-scanner/ngx/index.js");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                ...
                _shared_services_localStorage_service__WEBPACK_IMPORTED_MODULE_10__["LocalStorageService"],
                _shared_services_session_service__WEBPACK_IMPORTED_MODULE_11__["SessionService"],
                _shared_services_crud_service__WEBPACK_IMPORTED_MODULE_12__["CrudService"],
                _ionic_native_camera_preview_ngx__WEBPACK_IMPORTED_MODULE_14__["CameraPreview"],
...
var environment = {
    api_url: "https://22690eff.ngrok.io/api/",
    file_url: "https://22690eff.ngrok.io/"
};
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _session_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./session.service */ "./src/app/shared/services/session.service.ts");
...
/* harmony import */ var src_app_enviroments__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/enviroments */ "./src/app/enviroments.ts");
...
var CrudService = /** @class */ (function () {
    function CrudService(http, authService) {
        this.http = http;
        this.authService = authService;
    }
    CrudService.prototype.setHeaders = function () {
        var headersConfig = {
            'Content-Type': 'application/json',
            'Accept': 'application/json',
            'Authorization': ''
        };
        var authHeader = this.authService.getAuthHeader();
        if (authHeader) {
    ...
    CrudService.prototype.get = function (path) {
        return this.http.get("" + src_app_enviroments__WEBPACK_IMPORTED_MODULE_3__["environment"].api_url + path, { headers: this.setHeaders() });
    };
    CrudService.prototype.put = function (path, body) {
        if (body === void 0) { body = {}; }
        return this.http.put("" + src_app_enviroments__WEBPACK_IMPORTED_MODULE_3__["environment"].api_url + path, JSON.stringify(body), { headers: this.setHeaders() });
    };
    CrudService.prototype.delete = function (path) {
        return this.http.delete("" + src_app_enviroments__WEBPACK_IMPORTED_MODULE_3__["environment"].api_url + path, { headers: this.setHeaders() });
    };
    CrudService.prototype.deleteWithBody = function (path, body) {
        if (body === void 0) { body = {}; }
        return this.http.request('DELETE', "" + src_app_enviroments__WEBPACK_IMPORTED_MODULE_3__["environment"].api_url + path, {
            headers: this.setHeaders(),
            body: JSON.stringify(body)
        });
    };
    CrudService.prototype.post = function (path, body) {
        if (body === void 0) { body = {}; }
        return this.http.post("" + src_app_enviroments__WEBPACK_IMPORTED_MODULE_3__["environment"].api_url + path, JSON.stringify(body), { headers: this.setHeaders() });
    };
...
var LocalStorageService = /** @class */ (function () {
    ...
    LocalStorageService.prototype.setAuthUser = function (user, isObject) {
        this.setDefault('authUser', user, isObject);
    };
    LocalStorageService.prototype.getAuthUser = function (isObject) {
        return this.getDefault('authUser', isObject);
    };
    LocalStorageService.prototype.setAuthToken = function (user, isObject) {
        this.setDefault('authToken', user, isObject);
    };
    LocalStorageService.prototype.getAuthToken = function (isObject) {
        return this.getDefault('authToken', isObject);
    };
    LocalStorageService.prototype.setDefault = function (key, value, isObject) {
        if (isObject) {
    ...
    LocalStorageService.prototype.getDefault = function (key, isObject) {
        if (isObject) {
    ...
    LocalStorageService.prototype.removeDefault = function (key) {
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _localStorage_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./localStorage.service */ "./src/app/shared/services/localStorage.service.ts");
...
var SessionService = /** @class */ (function () {
    ...
    SessionService.prototype.getAuthUser = function () {
        return this.localStorageService.getAuthUser(true);
    };
    SessionService.prototype.setAuthUser = function (user) {
    ...
    SessionService.prototype.removeAuth = function () {
    ...
    SessionService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_localStorage_service__WEBPACK_IMPORTED_MODULE_2__["LocalStorageService"]])
    ], SessionService);
...
module.exports = __webpack_require__(/*! D:\repos\BusinessCardManager\BCMMobile\src\main.ts */"./src/main.ts");
